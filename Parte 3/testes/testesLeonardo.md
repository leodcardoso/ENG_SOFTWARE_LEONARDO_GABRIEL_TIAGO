...
Para isso foram criados os arquivos de [validação](../Parte\2/EngSoftware/Backend/src/utils) e de [casos de teste](../src/testes/Leonardo/sendFriendRequest.test.js)
